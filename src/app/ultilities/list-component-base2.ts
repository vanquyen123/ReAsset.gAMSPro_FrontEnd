...
export abstract class ListComponentBase2<T1, T2> extends DefaultComponentBase implements AfterContentInit, IListComponent {

    @ViewChild('coreTable') dataTable: CoreTableComponent<T1>;
    ...
    private _filterInputSearch: T2;
    public get filterInputSearch(): T2 {
        return this._filterInputSearch;
    }
    public set filterInputSearch(value: T2) {
    ...
    onUpdate(item: T1): void {
    }

    onViewDetail(item: T1): void {
    }

    onDblclick(record: T1) {
