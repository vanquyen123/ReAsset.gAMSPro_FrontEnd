...
export class AssetLookupComponent extends ListComponentBase<REA_OWNER_ENTITY> implements IUiAction<REA_OWNER_ENTITY>, OnInit, AfterViewInit{
...
search(): void {
  ...
  onAdd(): void {
      this.navigatePassParam('/app/admin/asset-lookup-add', null, { filterInput: JSON.stringify(this.filterInputSearch) });
  }

  onUpdate(item: REA_OWNER_ENTITY): void {
      this.navigatePassParam('/app/admin/asset-lookup-edit', { asset: item.owneR_ID }, { filterInput: JSON.stringify(this.filterInputSearch) });
  }
  ...
  onViewDetail(item: REA_OWNER_ENTITY): void {
      this.navigatePassParam('/app/admin/asset-lookup-view', { asset: item.owneR_ID }, { filterInput: JSON.stringify(this.filterInputSearch) });
  }
