...
import { EntityDtoOfInt64, UserListDto, UserServiceProxy, CM_BRANCH_ENTITY,CM_DEPARTMENT_ENTITY,DepartmentServiceProxy, BranchServiceProxy, GetUsersInput, ReportInfo, AsposeServiceProxy } from '@shared/service-proxies/service-proxies';
...
export class UsersComponent extends AppComponentBase implements OnInit, AfterContentChecked {
    ...
    getRolesAsString(roles): string {
        ...
        for (let j = 0; j < result.length; j++) {
            ...
            roleNames = roleNames + result[j].roleName;
        }
