...
export class GoodsEditComponent extends DefaultComponentBase implements OnInit, IUiAction<CM_GOODS_ENTITY>, AfterViewInit {
    constructor(
        injector: Injector,
    ...
    saveInput() {
        ...
        if (this.editPageState != EditPageState.viewDetail) {
            ...
            this.inputModel.gD_CODE = this.inputModel.gD_CODE.replace(/\s+/g, '').trim();
    ...
    goBack() {
        this.navigatePassParam('/app/admin/goods', null, undefined);
    }
