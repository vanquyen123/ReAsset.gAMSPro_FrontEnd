...
export class AppMenuListComponent extends ListComponentBase<TL_MENU_ENTITY> implements IUiAction<TL_MENU_ENTITY>, OnInit, AfterViewInit {
    ...
    onUpdate(item: TL_MENU_ENTITY): void {
        this.navigatePassParam('/app/admin/app-menu-edit', { menu: item.menU_ID }, { filterInput: JSON.stringify(this.filterInputSearch) });
    }
    ...
    onViewDetail(item: TL_MENU_ENTITY): void {
        this.navigatePassParam('/app/admin/app-menu-view', { menu: item.menU_ID }, { filterInput: JSON.stringify(this.filterInputSearch) });
    }
