...
export class InsuCompanyEditComponent extends DefaultComponentBase implements OnInit, IUiAction<CM_INSU_COMPANY_ENTITY>, AfterViewInit {
    ...
    goBack() {
        this.navigatePassParam('/app/admin/insu-company', null, undefined);
    }
