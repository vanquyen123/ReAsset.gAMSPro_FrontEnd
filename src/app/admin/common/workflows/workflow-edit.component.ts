...
export class WorkflowEditComponent extends DefaultComponentBase implements OnInit, IUiAction<CM_WORKFLOW_ENTITY>, AfterViewInit {
    constructor(
        injector: Injector,
    ...
    goBack() {
        this.navigatePassParam('/app/admin/workflow', null, undefined);
    }
