...
@Component({
    selector: "money-input-custom",
    templateUrl: "./money-input-custom.component.html",
    encapsulation: ViewEncapsulation.None,
    providers: [createCustomInputControlValueAccessor(MoneyInputCustomComponent)]
})

export class MoneyInputCustomComponent extends ControlComponent implements OnInit {
