...
import { TenantDashboardServiceProxy, SalesSummaryDatePeriod, GetGeneralStatsInput, GetRegionalStatsInput } from '@shared/service-proxies/service-proxies';
...
class RegionalStatsTable extends DashboardChartBase {
    ...
    reload() {
        this.showLoading();
        this._dashboardService
            .getRegionalStats({} as GetRegionalStatsInput)
            .subscribe(result => {
...
class GeneralStatsPieChart extends DashboardChartBase {
    ...
    reload() {
        this.showLoading();
        this._dashboardService
            .getGeneralStats({} as GetGeneralStatsInput)
            .subscribe(result => {
