...
function FileSelectedMulti(paths) {
    if (window.parent.onSelectCustomRoxyMulti) {
        window.parent.onSelectCustomRoxyMulti(paths);
    }

    if (window.parent.closeCustomRoxy) {
...
function FileSelected(file) {
    ...
    if (window.parent.onSelectCustomRoxy) {
        window.parent.onSelectCustomRoxy(file.fullPath);
    }
